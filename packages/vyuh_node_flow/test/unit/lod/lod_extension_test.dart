/// Unit tests for the [LodExtension] class.
///
...
void main() {
  // ===========================================================================
  // LodExtension - Individual Threshold Setters
  // ===========================================================================

  group('LodExtension - setMinThreshold', () {
    test('setMinThreshold updates the minimum threshold value', () {
      final controller = NodeFlowController<String, dynamic>(
        config: NodeFlowConfig(
          ...
          maxZoom: 1.0,
          extensions: [
            LodExtension(enabled: true, minThreshold: 0.1, midThreshold: 0.5),
  ...
  group('LodExtension - setMidThreshold', () {
  ...
  // ===========================================================================
  // LodExtension - Individual Visibility Setters
  // ===========================================================================

  group('LodExtension - setMinVisibility', () {
    test('setMinVisibility updates the minimum visibility configuration', () {
      final controller = NodeFlowController<String, dynamic>(
        config: NodeFlowConfig(
          ...
          maxZoom: 1.0,
          extensions: [
            LodExtension(enabled: true, minThreshold: 0.3, midThreshold: 0.6),
            ...NodeFlowConfig.defaultExtensions().where(
              (e) => e is! LodExtension,
            ),
          ],
  ...
  group('LodExtension - setMidVisibility', () {
    test('setMidVisibility updates the mid visibility configuration', () {
      final controller = NodeFlowController<String, dynamic>(
        config: NodeFlowConfig(
          ...
          maxZoom: 1.0,
          extensions: [
            LodExtension(enabled: true, minThreshold: 0.2, midThreshold: 0.8),
            ...NodeFlowConfig.defaultExtensions().where(
              (e) => e is! LodExtension,
            ),
          ],
  ...
  group('LodExtension - setMaxVisibility', () {
    test('setMaxVisibility updates the maximum visibility configuration', () {
      final controller = NodeFlowController<String, dynamic>(
        config: NodeFlowConfig(
          ...
          maxZoom: 1.0,
          extensions: [
            LodExtension(enabled: true, minThreshold: 0.2, midThreshold: 0.5),
            ...NodeFlowConfig.defaultExtensions().where(
              (e) => e is! LodExtension,
            ),
          ],
    ...
    test('setMaxVisibility affects disabled LOD state', () {
      final controller = NodeFlowController<String, dynamic>(
        config: NodeFlowConfig(
          ...
          maxZoom: 1.0,
          extensions: [
            LodExtension(enabled: false), // LOD disabled
            ...NodeFlowConfig.defaultExtensions().where(
              (e) => e is! LodExtension,
            ),
          ],
  ...
  // ===========================================================================
  // LodExtension - setEnabled Method
  // ===========================================================================

  group('LodExtension - setEnabled', () {
    test('setEnabled(true) enables LOD functionality', () {
      final controller = NodeFlowController<String, dynamic>(
        config: NodeFlowConfig(
          ...
          maxZoom: 1.0,
          extensions: [
            LodExtension(enabled: false, minThreshold: 0.3, midThreshold: 0.6),
            ...NodeFlowConfig.defaultExtensions().where(
              (e) => e is! LodExtension,
            ),
          ],
  ...
  // ===========================================================================
  // LodExtension - Extension ID
  // ===========================================================================

  group('LodExtension - Extension ID', () {
  ...
  // ===========================================================================
  // LodExtension - Normalized Zoom Edge Cases
  // ===========================================================================

  group('LodExtension - Normalized Zoom Edge Cases', () {
  ...
  // ===========================================================================
  // LodExtension - enable() Method
  // ===========================================================================

  group('LodExtension - enable() Method', () {
  ...
  // ===========================================================================
  // LodExtension - Lifecycle Methods
  // ===========================================================================

  group('LodExtension - Lifecycle Methods', () {
    ...
    test('detach cleans up controller reference', () {
      ...
      // Extension is attached, verify it has 'lod' id
      expect(lod.id, equals('lod'));
