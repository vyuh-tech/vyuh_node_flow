...
void main() {
  ...
  // ===========================================================================
  // MinimapExtension Lifecycle Tests
  // ===========================================================================

  group('MinimapExtension - Lifecycle', () {
    test('has correct id', () {
      final extension = MinimapExtension();
  ...
  // ===========================================================================
  // MinimapExtension Visibility Tests
  // ===========================================================================
  ...
  group('MinimapExtension - Visibility', () {
    ...
    test('can be initialized with visibility true', () {
      final extension = MinimapExtension(visible: true);
  ...
  group('MinimapExtension - Size', () {
    ...
    test('can be initialized with custom size', () {
      final extension = MinimapExtension(size: const Size(300, 200));
    ...
    test('setWidth() updates only width', () {
      final extension = MinimapExtension(size: const Size(200, 150));
  ...
  // ===========================================================================
  // MinimapExtension Interactivity Tests
  // ===========================================================================
  ...
  group('MinimapExtension - Interactivity', () {
    ...
    test('can be initialized with interactive false', () {
      final extension = MinimapExtension(interactive: false);
  ...
  // ===========================================================================
  // MinimapExtension Position Tests
  // ===========================================================================
  ...
  group('MinimapExtension - Position', () {
    ...
    test('can be initialized with custom position', () {
      final extension = MinimapExtension(position: MinimapPosition.topLeft);
    ...
    test('cyclePosition() wraps around correctly', () {
      final extension = MinimapExtension(position: MinimapPosition.bottomRight);
      extension.cyclePosition();
      expect(extension.position, equals(MinimapPosition.topLeft));
    });
  });
  ...
  // ===========================================================================
  // MinimapExtension Highlighting Tests
  // ===========================================================================
  ...
  group('MinimapExtension - Highlighting', () {
    ...
    test('can be initialized with autoHighlightSelection false', () {
      final extension = MinimapExtension(autoHighlightSelection: false);
  ...
  // ===========================================================================
  // MinimapExtension Navigation Tests
  // ===========================================================================

  group('MinimapExtension - Navigation', () {
  ...
  // ===========================================================================
  // MinimapExtension onEvent Tests
  // ===========================================================================

  group('MinimapExtension - onEvent', () {
    test('auto-highlights selected nodes when enabled', () {
      final extension = MinimapExtension(autoHighlightSelection: true);
      extension.attach(controller);
  ...
  // ===========================================================================
  // MinimapExtension Theme Tests
  // ===========================================================================

  group('MinimapExtension - Theme', () {
    ...
    test('can be initialized with dark theme', () {
      final extension = MinimapExtension(theme: MinimapTheme.dark);
    ...
    test('can be initialized with custom theme', () {
      ...
      final extension = MinimapExtension(theme: customTheme);
  ...
  // ===========================================================================
  // MinimapExtension Margin Tests
  // ===========================================================================

  group('MinimapExtension - Margin', () {
    ...
    test('can be initialized with custom margin', () {
      final extension = MinimapExtension(margin: 30.0);
      expect(extension.margin, equals(30.0));
    });

    test('margin of zero is valid', () {
      final extension = MinimapExtension(margin: 0.0);
      expect(extension.margin, equals(0.0));
    });
  });

  // ===========================================================================
  // MinimapExtensionAccess Tests
  // ===========================================================================

  group('MinimapExtensionAccess', () {
    test('returns null when extension is not registered', () {
      ...
      final noMinimapController = createTestController(
        config: createTestConfig(
          extensions: [], // Empty extensions - no minimap
        ),
      );
    ...
    test('returns extension when registered', () {
      ...
      final extension = MinimapExtension(visible: true);
      testController.addExtension(extension);
    ...
    test('can access extension methods via accessor', () {
      // Default controller already has MinimapExtension
    ...
    test('returns null after extension is removed', () {
      ...
      testController.removeExtension(extension.id);
    ...
    test('default controller has minimap extension', () {
      // The default controller created in setUp has MinimapExtension
      expect(controller.minimap, isNotNull);
    });
  });

  // ===========================================================================
  // MinimapExtension Edge Cases
  // ===========================================================================

  group('MinimapExtension - Edge Cases', () {
    ...
    test('all MinimapPosition values are valid', () {
      for (final position in MinimapPosition.values) {
        final extension = MinimapExtension(position: position);
  ...
  // ===========================================================================
  // MinimapExtension - Viewport Synchronization Tests
  // ===========================================================================

  group('MinimapExtension - Viewport Synchronization', () {
