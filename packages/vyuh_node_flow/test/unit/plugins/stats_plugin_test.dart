/// Unit tests for the [StatsPlugin] class.
///
/// Tests cover:
/// - Plugin construction and lifecycle
...
void main() {
  ...
  // ===========================================================================
  // StatsPlugin - Construction and Lifecycle
  // ===========================================================================
  ...
  group('StatsPlugin - Lifecycle', () {
    ...
    test('detach clears controller reference', () {
      ...
      final controller = NodeFlowController<String, dynamic>(
        config: NodeFlowConfig(plugins: [stats]),
      );
      ...
      controller.removePlugin('stats');

      // After removal, controller should not have stats
      expect(controller.hasPlugin('stats'), isFalse);
  ...
  // ===========================================================================
  // StatsPlugin - Node Statistics
  // ===========================================================================

  group('StatsPlugin - Node Counts', () {
  ...
  group('StatsPlugin - Visible Node Count', () {
  ...
  group('StatsPlugin - Locked Node Count', () {
  ...
  group('StatsPlugin - Special Node Counts', () {
  ...
  group('StatsPlugin - Nodes By Type', () {
  ...
  // ===========================================================================
  // StatsPlugin - Connection Statistics
  // ===========================================================================

  group('StatsPlugin - Connection Count', () {
  ...
  group('StatsPlugin - Labeled Connection Count', () {
  ...
  group('StatsPlugin - Average Connections Per Node', () {
  ...
  // ===========================================================================
  // StatsPlugin - Selection Statistics
  // ===========================================================================

  group('StatsPlugin - Selected Node Count', () {
  ...
  group('StatsPlugin - Selected Connection Count', () {
  ...
  group('StatsPlugin - Total Selection Count', () {
  ...
  group('StatsPlugin - Has Selection', () {
  ...
  group('StatsPlugin - Multi Selection', () {
  ...
  // ===========================================================================
  // StatsPlugin - Viewport Statistics
  // ===========================================================================

  group('StatsPlugin - Viewport Observable', () {
  ...
  group('StatsPlugin - Zoom Statistics', () {
  ...
  group('StatsPlugin - Pan Statistics', () {
  ...
  group('StatsPlugin - LOD Level', () {
    test('lodLevel returns full when LOD disabled', () {
      final controller = NodeFlowController<String, dynamic>(
        config: NodeFlowConfig(
          plugins: [StatsPlugin(), LodPlugin(enabled: false)],
        ),
      );
      final stats = controller.stats!;
  ...
  // ===========================================================================
  // StatsPlugin - Bounds Statistics
  // ===========================================================================

  group('StatsPlugin - Bounds', () {
  ...
  // ===========================================================================
  // StatsPlugin - Performance Statistics
  // ===========================================================================

  group('StatsPlugin - Visible Nodes In Viewport', () {
  ...
  group('StatsPlugin - Large Graph Detection', () {
  ...
  group('StatsPlugin - Node Density', () {
  ...
  // ===========================================================================
  // StatsPlugin - Summary Helpers
  // ===========================================================================

  group('StatsPlugin - Graph Summary', () {
  ...
  group('StatsPlugin - Selection Summary', () {
  ...
  group('StatsPlugin - Viewport Summary', () {
  ...
  group('StatsPlugin - Bounds Summary', () {
  ...
  // ===========================================================================
  // StatsPlugin - Controller Plugin Access
  // ===========================================================================

  group('StatsPlugin - Controller Plugin Access', () {
    test('stats getter returns extension when registered', () {
      ...
      expect(controller.stats, isNotNull);
      expect(controller.stats, isA<StatsPlugin>());
    ...
    test('stats can be accessed via resolvePlugin', () {
      final controller = NodeFlowController<String, dynamic>(
        config: NodeFlowConfig(plugins: [StatsPlugin()]),
      );

      final stats = controller.resolvePlugin<StatsPlugin>();

      expect(stats, isNotNull);
      expect(stats, isA<StatsPlugin>());
  ...
  // ===========================================================================
  // StatsPlugin - Reactivity
  // ===========================================================================

  group('StatsPlugin - Reactivity', () {
  ...
  // ===========================================================================
  // StatsPlugin - Edge Cases
  // ===========================================================================

  group('StatsPlugin - Edge Cases', () {
