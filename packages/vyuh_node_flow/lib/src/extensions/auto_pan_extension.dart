...
extension AutoPanExtensionAccess<T> on NodeFlowController<T> {
  /// Gets the autopan extension.
  ///
  ...
  AutoPanExtension get autoPan {
    var ext = getExtension<AutoPanExtension>();
    if (ext == null) {
      ext = config.extensionRegistry.get<AutoPanExtension>();
      assert(
        ext != null,
        'AutoPanExtension not found. Add it to NodeFlowConfig.extensions.',
      );
      addExtension(ext!);
    }
    return ext;
