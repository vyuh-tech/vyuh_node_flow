...
/// ```
class AutoPanPlugin extends NodeFlowPlugin {
  /// Creates an autopan plugin.
  ///
...
extension AutoPanPluginAccess<T> on NodeFlowController<T, dynamic> {
  /// Gets the autopan plugin, or null if not configured.
  ///
  ...
  AutoPanPlugin? get autoPan => resolvePlugin<AutoPanPlugin>();
}
