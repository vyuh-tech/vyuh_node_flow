...
///
/// This plugin uses `void` as its config type since it doesn't require
/// any configuration.
///
...
/// ```
class StatsPlugin extends NodeFlowPlugin {
  /// Creates a stats plugin.
  StatsPlugin();
...
extension StatsPluginAccess<T> on NodeFlowController<T, dynamic> {
  /// Gets the stats plugin, or null if not configured.
  ///
  ...
  StatsPlugin? get stats => resolvePlugin<StatsPlugin>();
}
