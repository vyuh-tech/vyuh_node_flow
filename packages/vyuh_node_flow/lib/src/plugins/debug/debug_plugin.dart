...
/// ```
class DebugPlugin extends NodeFlowPlugin implements LayerProvider {
...
extension DebugPluginAccess<T> on NodeFlowController<T, dynamic> {
  /// Gets the debug plugin, or null if not configured.
  ///
  ...
  DebugPlugin? get debug => resolvePlugin<DebugPlugin>();
}
