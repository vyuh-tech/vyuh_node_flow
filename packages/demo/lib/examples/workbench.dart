...
class _WorkbenchExampleState extends State<WorkbenchExample> {
  ...
  Future<NodeGraph<Map<String, dynamic>, dynamic>> _loadGraphFromJson(
    String filename,
  ) async {
    try {
  ...
  NodeGraph<Map<String, dynamic>, dynamic> _createFallbackGraph() {
    return NodeGraph<Map<String, dynamic>, dynamic>(
      nodes: [
