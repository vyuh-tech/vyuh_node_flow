...
class _InteractiveWidgetsExampleState extends State<InteractiveWidgetsExample> {
  late final NodeFlowController<InteractiveNodeData> _controller;
  ...
  Widget build(BuildContext context) {
    return ResponsiveControlPanel(
      ...
      width: 320,
      child: NodeFlowEditor<InteractiveNodeData>(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        ControlButton(
          label: 'Add Button Node',
          icon: Icons.smart_button,
          onPressed: _addButtonNode,
        ),
        const SizedBox(height: 8),
        ControlButton(
          label: 'Add TextField Node',
          icon: Icons.text_fields,
          onPressed: _addTextFieldNode,
        ),
        const SizedBox(height: 8),
        ControlButton(
          label: 'Add Slider Node',
          icon: Icons.tune,
