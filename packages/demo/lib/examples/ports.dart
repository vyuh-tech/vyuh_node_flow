...
class _PortCombinationsDemoState extends State<PortCombinationsDemo>
  ...
  void initState() {
    ...
    // Initialize example with initial graph
    initExample();
                ...
                children: PortPosition.values
                    .map(
                      (port) => StyledChip(
                        ...
                        selected:
                            _themeControl._selectedSourcePort.value == port,
                        onSelected: (selected) {
                          if (selected) {
                ...
                children: PortPosition.values
                    .map(
                      (port) => StyledChip(
                        label: port.name.toUpperCase(),
                        selected:
                            _themeControl._selectedTargetPort.value == port,
                        onSelected: (selected) {
                          if (selected) {
              ...
              builder: (context) => Column(
                ...
                children: [
                  ...
                  Slider(
                    ...
                    max: 50,
                    divisions: 45,
                    label: _themeControl._portExtension.value.toStringAsFixed(
                      1,
                    ),
                    onChanged: (value) {
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        Slider(
                          ...
                          max: 1.0,
                          divisions: 20,
                          label: _themeControl._curvature.value.toStringAsFixed(
                            2,
                          ),
                          onChanged: (value) {
