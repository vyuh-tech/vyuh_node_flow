...
- [Configuration](/docs/concepts/configuration) - General extension configuration
- [Minimap](/docs/extensions/minimap) - Another navigation aid
- [Level of Detail](/docs/extensions/lod) - Performance optimization for large graphs
