...
<MediaPlaceholder
  ...
  description="NodeFlowEditor with minimap in bottom-right corner. Minimap shows scaled-down view of entire graph with nodes as small rectangles, viewport indicator as highlighted rectangle showing current visible area. Main editor shows zoomed-in portion of the graph."
  aspectRatio="16/9"
/>
...
- [Controller](/docs/node-flow/core-concepts/controller) - Managing viewport and navigation
- [Examples](/docs/node-flow/examples) - See minimap in action
