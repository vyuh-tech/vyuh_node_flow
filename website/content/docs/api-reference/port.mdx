...
<Tabs items={['Basic', 'With Labels', 'Custom Configuration']}>
  <Tab value="Basic">
    ```dart
...
See [Port Shapes](/docs/node-flow/theming/port-shapes) and [Port Labels](/docs/node-flow/theming/port-labels) for more styling details.
