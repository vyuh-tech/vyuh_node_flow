...
<Tabs items={['Basic', 'With Labels', 'Custom Style']}>
  <Tab value="Basic">
    ```dart
...
See [Connection Styles](/docs/node-flow/theming/connection-styles) and [Connection Effects](/docs/node-flow/theming/connection-effects) for more.
