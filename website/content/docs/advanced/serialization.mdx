...
<MediaPlaceholder
  ...
  description="Diagram showing graph data flow: NodeFlowController → toJson() → JSON structure (nodes array, connections array, annotations array, viewport state) → File/Database/Cloud. Reverse arrow showing fromJson() loading back into controller."
  aspectRatio="16/9"
/>
...
- [Graph API](/docs/node-flow/core-concepts/controller)
- [Node Data](/docs/node-flow/core-concepts/nodes)
- [Examples](/docs/node-flow/examples)
