...
- [Keyboard Shortcuts](/docs/node-flow/advanced/keyboard-shortcuts) - User guide to shortcuts
- [Controller](/docs/node-flow/core-concepts/controller) - Controller API
- [Examples](/docs/node-flow/examples) - See custom actions in practice
